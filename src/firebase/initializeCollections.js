  ...
  try {
    ...
    await createCollectionIfNotExists('solicitudes_cv', {
      ...
      data: {
        ...
        descripcionCargo: 'Buscamos un desarrollador frontend con experiencia en React y TypeScript para unirse a nuestro equipo.',
    ...
    await createCollectionIfNotExists('mensajes_contacto', {
      ...
      data: {
        ...
        mensaje: 'Estamos interesados en sus servicios de desarrollo web. ¿Podrían contactarnos?',
...
const createCollectionIfNotExists = async (collectionName, exampleDoc) => {
  try {
    ...
    if (!docSnap.exists()) {
      ...
      console.log(`📄 Colección '${collectionName}' creada con documento de ejemplo`)
    } else {
