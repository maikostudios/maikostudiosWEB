<template>
    <section class="relative text-light">
        <!-- Image removed temporarily due to missing file hero-bg.jpg -->
        <!-- <img src="/assets/hero-bg.jpg" class="absolute inset-0 h-full w-full object-cover -z-10"
            alt="Hero Background" /> -->
