<template>
    <div class="bg-night/70 backdrop-blur-lg rounded-2xl shadow-xl p-6 flex flex-col justify-between h-full">
        <div>
            <h3 class="text-xl font-semibold mb-2">{{ name }}</h3>
            <p class="text-2xl font-bold mb-4">{{ formatCurrency(price) }}</p>
