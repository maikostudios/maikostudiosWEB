...
const proyectosEjemplo = [
  {
    ...
    descripcion: "Sistema SaaS completo para gestión de transferencias financieras y administración de cuentas. Incluye dashboard administrativo, API REST, autenticación segura y reportes en tiempo real.",
    imagen: "https://raw.githubusercontent.com/maikostudios/assets_maikostudio/main/assets/img/proyectos/DeUna_home.png",
    tecnologias: ["Vue.js", "Node.js", "PostgreSQL", "Firebase", "Stripe", "JWT"],
  ...
  },
  {
    ...
    descripcion: "Sistema de autenticación empresarial con diseño moderno y funcionalidades avanzadas de seguridad. Incluye autenticación multifactor y gestión de sesiones.",
    imagen: "https://raw.githubusercontent.com/maikostudios/assets_maikostudio/main/assets/img/proyectos/DeUna_login.png",
    tecnologias: ["React", "TypeScript", "Node.js", "MongoDB", "Redis", "OAuth"],
  ...
  },
  {
    ...
    descripcion: "Tienda online completa con carrito de compras, integración de pagos múltiples, gestión de inventario y panel administrativo avanzado.",
  ...
  },
  {
    ...
    descripcion: "Panel de control empresarial con métricas en tiempo real, gráficos interactivos, reportes automatizados y exportación de datos.",
    imagen: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg",
    tecnologias: ["Vue.js", "Chart.js", "D3.js", "Python", "FastAPI", "PostgreSQL"],
  ...
  },
  {
    ...
    descripcion: "Aplicación móvil multiplataforma para gestión de tareas empresariales con sincronización en la nube y notificaciones push.",
  ...
  },
  {
    ...
    descripcion: "Arquitectura de microservicios escalable con documentación automática, testing integrado, monitoreo y deployment automatizado.",
    imagen: "https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg",
    tecnologias: ["Node.js", "Express.js", "Docker", "Kubernetes", "PostgreSQL", "Redis"],
...
window.limpiarProyectos = async function() {
  if (!confirm('⚠️ ¿Estás seguro de que quieres eliminar TODOS los proyectos?')) {
    return;
  }
