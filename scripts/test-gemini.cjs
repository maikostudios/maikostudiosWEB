...
const API_KEY = "tu_gemini_api_key_aqui" // Reemplazar con API key real
...
<body>
  ...
  const cvData = {
    ...
    perfil_profesional: "Desarrollador Full Stack con experiencia en Vue.js, Node.js y Firebase",
    experiencia_profesional: [
      {
        cargo: "Fundador y Desarrollador",
        empresa: "Maiko Studios",
        periodo: "2024 - Actualidad",
        descripcion: "Creación de plataformas como DeUna Transferencias, automatizaciones con IA"
      }
    ],
    habilidades_tecnicas: {
...
async function main() {
  ...
  console.log('\n✅ Pruebas completadas')
  console.log('\n📋 Próximos pasos:')
  console.log('1. Obtener API key de Gemini en: https://aistudio.google.com/app/apikey')
